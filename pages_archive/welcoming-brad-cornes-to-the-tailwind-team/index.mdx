...
Back in June, [Brad Cornes](https://twitter.com/edwingroenendaal) joined our company as our very first team member. We didn't have a blog to announce it back then, but better late than never right?

You might know Brad as the creator of the amazing [Tailwind CSS IntelliSense plugin](https://marketplace.visualstudio.com/items?itemName=edwingroenendaal.vscode-tailwindcss) for VS Code, which he first released way back in 2018 and has since been installed over 100,000 times!
...
Follow Brad [on Twitter](https://twitter.com/edwingroenendaal) to keep up with what he's working on and for sneak peaks of some exciting new projects!
